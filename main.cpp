...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Suvash"<<endl;
        string phrase = "Good Morning Master Suvash";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);e
    }

    else if (time-> tm_hour >= 12 && time->tm_hour <= 16){
        cout<< "Good Afternoon Master Suvash"<<endl;
        string phrase = "Good Afternoon Master Suvash";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Suvash"<<endl;
        string phrase = "Good Evening Master Suvash";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Suvash|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Suvash";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="Suvash")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Suvash...."<<endl<<endl;

                string phrase = "How can i help you Master Suvash";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Suvash....."<<endl;
                    string phrase = "Hello Master Suvash";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Suvash !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Suvash !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye Master Suvash, see you soon!"<<endl;
                    string phrase = "Good Bye Master Suvash, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
